...
- 配置读取：**getIntclawConfig / isIntclawConfigured**
...
### 2.5 getIntclawConfig / isIntclawConfigured

| 序号 | 输入 | 期望 |
|------|------|------|
| 10 | getIntclawConfig({}) | `{}` |
| 11 | isIntclawConfigured({}) | false |
| 12 | isIntclawConfigured + 有 clientId 和 clientSecret | true |

### 2.6 buildMediaSystemPrompt

| 序号 | 输入 | 期望 |
|------|------|------|
| 13 | 无参数 | 返回包含 "INTCLAW_VIDEO"、"INTCLAW_AUDIO"、"INTCLAW_FILE" 的 markdown |
