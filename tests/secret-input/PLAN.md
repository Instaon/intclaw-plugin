...
| 2 | `{ source: "env", provider: "system", id: "INTCLAW_SECRET" }` | 解析成功，返回结构化对象 |
...
| 6 | normalizeResolvedSecretInputString({ value: " b ", path: "channels.intclaw-connector.clientSecret" }) | `"b"` |
