 ...
 * 
 * @intclaw-real-ai/intclaw-connector
 */
...
async function sendFileProactive(
  ...
  await axios.post(`${INTCLAW_CONFIG.API_BASE_URL}/v1.0/robot/messageFiles/send`, {
...
async function sendVideoProactive(
  ...
  await axios.post(`${INTCLAW_CONFIG.API_BASE_URL}/v1.0/robot/videos/send`, {
    robotCode: config?.clientId,
    videoMediaId,
    picMediaId,
    metadata,
...
async function sendAudioProactive(
  ...
  await axios.post(`${INTCLAW_CONFIG.API_BASE_URL}/v1.0/robot/voices/send`, {
    robotCode: config?.clientId,
    audioMediaId,
    durationMs,
    fileName: fileInfo.fileName,
...
function resolveAgentIdByBindings(
  ...
  const CHANNEL = "intclaw-connector";
...
export const __testables = {
  ...
  getConfig: getIntclawConfig,
  isConfigured: isIntclawConfigured,
